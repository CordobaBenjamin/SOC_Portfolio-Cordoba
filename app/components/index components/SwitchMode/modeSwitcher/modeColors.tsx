...
const Colors: any = {
  light: {
    text: {
      ...
      textSecondary2: "text-red-600 transition-colors duration-200",
    ...
    color: {
      ...
      border: "border-red-700 transition-border-color duration-200",
      borderY: "border-x-gray-200 border-y-red-700 transition-border-color duration-200",
