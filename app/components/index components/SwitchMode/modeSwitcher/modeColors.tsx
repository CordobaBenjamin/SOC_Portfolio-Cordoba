...
const Colors: any = {
  light: {
    ...
    color: {
      ...
      borderY:
        "border-x-gray-200 border-y-emerald-700 transition-border-color duration-200",
      borderX:
        "border-x-transparent border-t-transparent border-b-emerald-700 transition-border-color duration-200",
      borderL:
        "border-r-transparent border-y-transparent border-l-emerald-700 transition-border-color duration-200",
  ...
  dark: {
    ...
    color: {
      ...
      borderY:
        "border-x-transparent border-y-emerald-900 transition-border-color duration-200",
      borderX:
        "border-x-transparent border-t-transparent border-b-emerald-900 transition-border-color duration-200",
      borderL:
        "border-r-transparent border-y-transparent border-l-emerald-900 transition-border-color duration-200",
