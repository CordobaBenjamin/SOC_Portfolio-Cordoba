...
const LanguageTexts: any = {
  ...
  en: {
    ...
    help_card: {
      ...
      span1:
        "For me, it is important to understand all aspects of the web development process, I’ll learn any necessary technology to achieve my goals.",
    ...
    game_project: {
      ...
      bspan4: "Webpack",
      bspan5:
        ", although the project is not extensive, it was a challenge to work on",
      bspan6: "the logic of the functions",
      bspan7:
        "in a game that depends on so many types of data, in a strongly-typed language like ",
      bspan9: "TypeScript.",
    },
    contact: {
      title: "Contact",
