  ...
  return (
    <div className={`mt-10 pb-14 w-fit mx-auto`}>
      <div className={`flex flex-col`}>
        <div
          className={`flex justify-center my-2 text=lg xl:text-2xl ${textSecondary} font-bold`}
        >
          <span className={``}>
            {" "}
            {title1}
        ...
        <div className={`flex justify-center  `}>
          <span className={`${textMain}  text-sm font-semibold xl:text-lg`}>
            {" "}
            {span1}{" "}
          </span>
        </div>
        ...
        <div className={`flex justify-center `}>
          <a
            href="https://github.com/CordobaBenjamin/BenjaminCordoba-Portfolio"
            target="_blank"
          >
            {" "}
            <span
              className={`${textMain} text-sm font-semibold xl:text-lg button-glow`}
            >
              {" "}
              {span2}{" "}
            </span>
