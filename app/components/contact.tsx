...
const Contact = () => {
  ...
  const { bg, borderSecondary, overlap } = Colors[mode].color;
        ...
        <div className=" flex  justify-center flex-col md:flex-row ">
          <div className="md:w-2/3 md:mt-0 lg:w-3/5 xl:w-11/12">
            ...
            <div className="flex justify-center flex-col mx-10 xl:flex-row  ">
              ...
              >
                <a
                  href="https://github.com/CordobaBenjamin?tab=repositories"
                  target="_blank"
                >
                  <div>
              ...
              >
                <a
                  href="https://wa.me/541132565554/?text=Hola!, le mando un mensaje para contactarme con usted."
                  target="_blank"
                >
                  <div>
                    <div className="w-12 h-12 p-2  mx-auto my-5  bg-transparent relative button-glow ">
